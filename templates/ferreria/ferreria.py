...
class FerreriaPDF(PDF):
    ...
    def header( self ) :
        ...
        self.image( load_resource( "generalitat.png" ), h=14)
        ...
        self.set_position( x=-22, y=0)
        self.image( load_resource( "iesferreria.png" ), h=14)
    ...
    def footer( self ) :
        ...
        self.set_font( "Arial", style="B", size=8 )
        self.write( date, x=-20, y=0, h=h, align="R" )
        self.set_font( "Arial", style="", size=8 )
        self.write( "Data:", x=-40, w=20, y=0, h=h, align="R" )
